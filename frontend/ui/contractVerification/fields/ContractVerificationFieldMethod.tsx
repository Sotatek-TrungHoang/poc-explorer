...
const ContractVerificationFieldMethod = ({ methods }: Props) => {
  ...
  const tooltipContent = (
    <Box>
      <span>Currently, MobiChain Explorer supports { methods.length } methods:</span>
  ...
  return (
    <>
      <Heading level="2" mt={{ base: 10, lg: 6 }} gridColumn={{ lg: '1 / 3' }}>
        Currently, MobiChain Explorer supports { methods.length }{ nbsp }contract verification methods
        <Hint
